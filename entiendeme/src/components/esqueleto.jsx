			...
			<React.Fragment>
				...
				<footer id="footer">
					<div className="mediaIcons">
						<a href="https://twitter.com/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faTwitter} size="2xl" style={{ color: "#ffffff", }} /></a>
						<a href="https://web.facebook.com/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faFacebookF} size="2xl" style={{ color: "#ffffff", }} /></a>
						<a href="https://www.instagram.com/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faInstagram} size="2xl" style={{ color: "#ffffff", }} /></a>
						<a href="mailto:info@entiendeme.com" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faEnvelope} size="2xl" style={{ color: "#ffffff", }} /></a>
					</div>
